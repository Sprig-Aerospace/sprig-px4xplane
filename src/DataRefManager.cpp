 ...
 * → When reconnecting, re-enabling override would apply old throttle/control values
 * → Aircraft would immediately fly with last commands
 *
 * SOLUTION: Zero ALL actuator datarefs BEFORE disabling override
 * → Common throttle/control surface datarefs set to 0.0
 * → All configured aircraft actuator datarefs set to 0.0
